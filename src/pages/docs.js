...
export default function Docs() {
  ...
  const getText = (key) => {
    const texts = {
      title: { id: "📖 Dokumentasi Resmi API Rafzhost", en: "📖 Rafzhost Official API Documentation" },
      switch: { id: "➡️ Beralih ke Post", en: "➡️ Switch to Post" },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900 text-black dark:text-white transition-colors duration-500">
      <header className="bg-blue-600 dark:bg-blue-800 text-white p-4 flex flex-col md:flex-row justify-between items-center gap-4 shadow-md animate-fadeIn">
        <h1 className="text-xl md:text-2xl font-bold">{getText("title")}</h1>
        <div className="flex flex-wrap gap-3 items-center">
          <a
            href="/post"
            className="px-4 py-2 rounded-lg bg-white text-blue-600 dark:bg-gray-700 dark:text-white font-semibold shadow hover:scale-105 transition"
          >
            {getText("switch")}
          </a>
