...
function DocsContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition animate-fadeIn">
      <header className="bg-blue-600 text-white p-4 flex flex-wrap justify-between items-center gap-3 shadow-md">
        <h1 className="text-xl font-bold">{texts.title[lang]}</h1>
        <div className="flex flex-wrap gap-2 items-center">
          <Link href="/post" className="btn btn-light text-blue-600">
            {texts.switch[lang]}
          </Link>
      ...
      <footer>
        <p>
          Thanks to{" "}
          <a href="https://github.com/siputzx/apisku" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline inline-flex items-center gap-1">
